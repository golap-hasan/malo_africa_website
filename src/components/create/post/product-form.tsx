        ...
        <div className="lg:col-span-5 space-y-8">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                ...
                <span className="font-semibold text-sm">I&apos;m Selling</span>
              </div>
              <div 
              ...
              >
                ...
                <span className="font-semibold text-sm">I&apos;m Buying</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <h3 className="font-semibold text-lg mb-1">Click to upload image</h3>
        ...
        <div className="lg:col-span-7 space-y-8">
          ...
          <div className="space-y-6 bg-card p-6 rounded-3xl border shadow-sm">
            ...
            <div className="space-y-2">
              ...
              <Input id="product-name" placeholder="e.g. iPhone 15 Pro Max" className="h-11 rounded-xl" />
            </div>
            ...
            <div className="space-y-2">
               ...
               <div className="flex items-center gap-4">
                 <div className="relative flex-1">
                    ...
                    <Input placeholder="Min" className="pl-12 h-11 rounded-xl" type="number" />
                 </div>
                 <span className="text-muted-foreground">-</span>
                 <div className="relative flex-1">
                    <span className="absolute left-3 top-3 text-muted-foreground text-sm">ZMW</span>
                    <Input placeholder="Max" className="pl-12 h-11 rounded-xl" type="number" />
                 </div>
               </div>
            </div>
          ...
          <div className="space-y-4">
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <p className="text-xs text-muted-foreground">Standard visibility. Good for quick sales.</p>
                </div>
                ...
                >
                  ...
                  <p className="text-xs text-muted-foreground">2x Reach. Featured on category pages.</p>
                </div>
                ...
                >
                  ...
                  <p className="text-xs text-muted-foreground">Top of search results + Homepage feature.</p>
                </div>
             </div>
          </div>
